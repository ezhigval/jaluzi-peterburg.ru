...
import { shortLeadFormSchema, type ShortLeadFormData } from '@/lib/schemas/lead-schemas'
import { useState } from 'react'

interface ShortLeadFormProps {
  onSubmit?: () => void
}

export function ShortLeadForm({ onSubmit }: ShortLeadFormProps) {
  ...
  const {
    ...
    resolver: zodResolver(shortLeadFormSchema),
  })

  const onSubmitForm = async (data: ShortLeadFormData) => {
    // Проверка honeypot
    if (data.honeypot) {
